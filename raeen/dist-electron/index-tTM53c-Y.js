...
class EventStreamSerde {
          ...
          for (const [name, member] of eventStreamSchema.structIterator()) {
            ...
            if (eventPayload) {
              if (member.isBlobSchema()) {
                ...
                out[name] = (((_a2 = this.serdeContext) == null ? void 0 : _a2.utf8Encoder) ?? main.toUtf8)(body);
  ...
  writeEventBody(unionMember, unionSchema, event) {
    ...
    const body = typeof messageSerialization === "string" ? (((_a = this.serdeContext) == null ? void 0 : _a.utf8Decoder) ?? main.fromUtf8)(messageSerialization) : messageSerialization;
    return {
      body,
      eventType,
