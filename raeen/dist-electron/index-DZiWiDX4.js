"use strict";
const index$1 = require("./index-BEVBnb6t.js");
...
function requireHttpAuthSchemeProvider() {
  ...
  (function(exports$1) {
    ...
    const core_1 = /* @__PURE__ */ main.requireDistCjs();
...
function requireRuntimeConfig_shared() {
  ...
  const core_1 = /* @__PURE__ */ main.requireDistCjs();
  const protocols_1 = /* @__PURE__ */ main.requireProtocols();
  const core_2 = /* @__PURE__ */ main.requireDistCjs$1();
...
function requireRuntimeExtensions() {
  ...
  const region_config_resolver_1 = index$1.require$$13$1;
  const protocol_http_1 = main.require$$14;
  const smithy_client_1 = main.require$$10;
...
function requireSTSClient() {
  ...
  (function(exports$1) {
    ...
    const middleware_host_header_1 = index$1.require$$0$1;
    const middleware_logger_1 = index$1.require$$1$2;
    const middleware_recursion_detection_1 = index$1.require$$2;
    const middleware_user_agent_1 = index$1.require$$3$1;
    const config_resolver_1 = index$1.require$$4$1;
    const core_1 = /* @__PURE__ */ main.requireDistCjs$1();
    const schema_1 = /* @__PURE__ */ main.requireSchema();
    const middleware_content_length_1 = index$1.require$$7$1;
    const middleware_endpoint_1 = index$1.require$$8$1;
    const middleware_retry_1 = index$1.require$$9$1;
    const smithy_client_1 = main.require$$10;
...
function requireSts() {
  ...
  (function(exports$1) {
    ...
    var schema = /* @__PURE__ */ main.requireSchema();
    var client = /* @__PURE__ */ main.requireClient();
    var regionConfigResolver = index$1.require$$13$1;
    let STSServiceException$1 = class STSServiceException2 extends smithyClient.ServiceException {
      constructor(options) {
        super(options);
        Object.setPrototypeOf(this, STSServiceException2.prototype);
      }
    };
    let ExpiredTokenException$1 = class ExpiredTokenException2 extends STSServiceException$1 {
    ...
    let MalformedPolicyDocumentException$1 = class MalformedPolicyDocumentException2 extends STSServiceException$1 {
    ...
    let PackedPolicyTooLargeException$1 = class PackedPolicyTooLargeException2 extends STSServiceException$1 {
    ...
    let RegionDisabledException$1 = class RegionDisabledException2 extends STSServiceException$1 {
    ...
    let IDPRejectedClaimException$1 = class IDPRejectedClaimException2 extends STSServiceException$1 {
    ...
    let InvalidIdentityTokenException$1 = class InvalidIdentityTokenException2 extends STSServiceException$1 {
    ...
    let IDPCommunicationErrorException$1 = class IDPCommunicationErrorException2 extends STSServiceException$1 {
    ...
    exports$1.IDPCommunicationErrorException = IDPCommunicationErrorException$1;
    exports$1.IDPRejectedClaimException = IDPRejectedClaimException$1;
    exports$1.InvalidIdentityTokenException = InvalidIdentityTokenException$1;
    exports$1.MalformedPolicyDocumentException = MalformedPolicyDocumentException$1;
    exports$1.PackedPolicyTooLargeException = PackedPolicyTooLargeException$1;
    exports$1.RegionDisabledException = RegionDisabledException$1;
    exports$1.STS = STS;
    exports$1.STSServiceException = STSServiceException$1;
