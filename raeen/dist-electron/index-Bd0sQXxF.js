...
const externalDataInterceptor = require("./externalDataInterceptor-DhaYy0a8.js");
...
const resolveProcessCredentials = async (profileName, profiles, logger) => {
  ...
  if (profiles[profileName]) {
    ...
    if (credentialProcess !== void 0) {
      const execPromise = util.promisify(externalDataInterceptor.externalDataInterceptor?.getTokenRecord?.().exec ?? require$$1.exec);
      try {
