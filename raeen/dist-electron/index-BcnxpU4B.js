...
const parseKnownFiles = require("./parseKnownFiles-B_4W6F7T.js");
const resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      const { fromHttp } = await Promise.resolve().then(() => require("./index-cFql1UvC.js"));
      const { fromContainerMetadata } = await Promise.resolve().then(() => require("./index-fSdLZWBv.js"));
    ...
    Ec2InstanceMetadata: async (options) => {
      ...
      const { fromInstanceMetadata } = await Promise.resolve().then(() => require("./index-fSdLZWBv.js"));
      return async () => fromInstanceMetadata(options)().then(setNamedProvider);
    },
    Environment: async (options) => {
      logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
      const { fromEnv } = await Promise.resolve().then(() => require("./index-DLbUMecp.js"));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData2) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./index-BDmCimTK.js")).then((n) => n.index);
...
class LoginCredentialsFetcher {
  ...
  async refresh(token) {
    const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./index-25sq-skY.js")).then((n) => n.index);
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => require("./index-DuIbNMCB.js")).then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
const resolveSsoCredentials = async (profile, profileData, options = {}) => {
  const { fromSSO } = await Promise.resolve().then(() => require("./index-C3cT6C9J.js"));
  return fromSSO({
    profile,
...
const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => require("./index-oXXuVkXg.js")).then(({ fromTokenFile }) => fromTokenFile({
