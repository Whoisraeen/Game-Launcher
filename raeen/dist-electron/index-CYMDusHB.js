...
const parseKnownFiles = require("./parseKnownFiles-e1kMAwe0.js");
const resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      const { fromHttp } = await Promise.resolve().then(() => require("./index-DImrYhvi.js"));
      const { fromContainerMetadata } = await Promise.resolve().then(() => require("./index-gFtV9HXN.js"));
    ...
    Ec2InstanceMetadata: async (options) => {
      ...
      const { fromInstanceMetadata } = await Promise.resolve().then(() => require("./index-gFtV9HXN.js"));
      return async () => fromInstanceMetadata(options)().then(setNamedProvider);
    },
    Environment: async (options) => {
      logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
      const { fromEnv } = await Promise.resolve().then(() => require("./index-3WdGBRgT.js"));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData2) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./index-Fp87PcUl.js")).then((n) => n.index);
...
class LoginCredentialsFetcher {
  ...
  async refresh(token) {
    const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./index-BzJCtIes.js")).then((n) => n.index);
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => require("./index-BfhCC4Sg.js")).then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
const resolveSsoCredentials = async (profile, profileData, options = {}) => {
  const { fromSSO } = await Promise.resolve().then(() => require("./index-zXSKDEMq.js"));
  return fromSSO({
    profile,
...
const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => require("./index-DHq9Hho6.js")).then(({ fromTokenFile }) => fromTokenFile({
