...
const fs = require("fs");
const externalDataInterceptor = require("./externalDataInterceptor-CO4ju58C.js");
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => require("./index-DFET1g9C.js"));
