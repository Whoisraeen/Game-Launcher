...
const parseKnownFiles = require("./parseKnownFiles-BV-2Qmkl.js");
const resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      const { fromHttp } = await Promise.resolve().then(() => require("./index-C5LXXqXB.js"));
      const { fromContainerMetadata } = await Promise.resolve().then(() => require("./index-DYL-C0-5.js"));
    ...
    Ec2InstanceMetadata: async (options) => {
      ...
      const { fromInstanceMetadata } = await Promise.resolve().then(() => require("./index-DYL-C0-5.js"));
      return async () => fromInstanceMetadata(options)().then(setNamedProvider);
    },
    Environment: async (options) => {
      logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
      const { fromEnv } = await Promise.resolve().then(() => require("./index-BTIHZYfC.js"));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData2) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./index-4nKRFJZj.js")).then((n) => n.index);
...
class LoginCredentialsFetcher {
  ...
  async refresh(token) {
    const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./index-CA446wUz.js")).then((n) => n.index);
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => require("./index-DiDIxbce.js")).then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
const resolveSsoCredentials = async (profile, profileData, options = {}) => {
  const { fromSSO } = await Promise.resolve().then(() => require("./index-BaaUmpxX.js"));
  return fromSSO({
    profile,
...
const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => require("./index-DVGoAy4q.js")).then(({ fromTokenFile }) => fromTokenFile({
