...
const fs = require("fs");
const externalDataInterceptor = require("./externalDataInterceptor-qt468DK-.js");
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => require("./index-DsRrOyjq.js"));
