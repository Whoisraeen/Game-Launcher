...
const fs = require("fs");
const externalDataInterceptor = require("./externalDataInterceptor-C3SeKBev.js");
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => require("./index-BsJbWlBe.js"));
